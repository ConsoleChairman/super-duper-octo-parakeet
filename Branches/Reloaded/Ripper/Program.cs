...
namespace Ripper
{
    class Program
    {
        private const string RootDownloadURL = @"http://www.reloaded.org";
        private const string SavePathRoot = @"D:\Site Rips\Reloaded\";
        public static readonly string Site = @"http://www.reloaded.org/allgames-Games/";
